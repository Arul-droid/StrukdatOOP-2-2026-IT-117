...
public class GameAction extends Game {
    ...
    /** Skor Action: boss(40)×multiplier_kesulitan + achievement(30) + jam(20) + challenge(10) */
    @Override
    public int hitungSkorReview() {
...
══════════ SESI MAIN: ELDEN RING ══════════
  ...
  [🔓] Achievement unlocked: "Dragonslayer" +200 XP (total XP: 200)
  [📖] Chapter 1/12 selesai di "Elden Ring"
  ...
...
══════════ DEMO FILTER ══════════
  🔍 Filter: Status = ✅ Tamat — 2 game ditemukan
  🔍 Filter: Jam main ≥ 30 jam — 2 game ditemukan
  🔍 Filter: Skor review ≥ 70 — 2 game ditemukan
...
- `GameAction` menghitung berdasarkan **boss** yang dikalahkan × **multiplier kesulitan** + bonus **mode challenge**
